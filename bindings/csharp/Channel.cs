...
namespace iio
{
    ...
    public class Channel
    {
        ...
        public readonly IReadOnlyList<Attr> event_attrs;
        ...
        internal Channel(Device dev, IntPtr chn)
        {
            ...
            var eventAttrsList = new List<Attr>();
            for (uint i = 0; i < nb_event_attrs; i++)
            {
                eventAttrsList.Add(new Attr(iio_channel_get_event_attr(chn, i)));
            }
            event_attrs = eventAttrsList;
